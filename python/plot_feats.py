...
def main():
    file1 = pd.read_csv("collected_data/only_features.csv", skiprows=6)
    ...
    power = filter(file1["Curr avg 1"] * file1["Volt avg 1"], 32)
    ...
    plt.ylim(0, 0.5)
    plt.grid()
    fig.savefig("only_features.eps", bbox_inches='tight')
